...
import '../globals.css';
import { loadRootBootstrap } from '../lib/bootstrap/app-shell-bootstrap';
import { TauriReadySignal } from '../lib/platform/TauriReadySignal';
import { PROMPT_DRAFT_CAPTURE_SCRIPT_SRC } from '../lib/prompt/hydration-draft-capture';
  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        <TauriReadySignal />
        <script src={PROMPT_DRAFT_CAPTURE_SCRIPT_SRC} />
