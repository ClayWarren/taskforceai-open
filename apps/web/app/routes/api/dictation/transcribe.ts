...
const DICTATION_RATE_LIMIT_WINDOW_MS = 60_000;
const DICTATION_MAX_REQUESTS_PER_WINDOW = 12;
...
const handleDictationTranscribe = async ({ request }: { request: Request }) => {
  ...
  const rateLimit = consumeVoiceRequestLimit('dictation', request, auth, {
    maxRequests: DICTATION_MAX_REQUESTS_PER_WINDOW,
