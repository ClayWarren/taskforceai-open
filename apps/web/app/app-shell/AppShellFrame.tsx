...
export function AppShellFrame({
  ...
  const shouldRenderCenteredPrompt =
    ...
    (promptVariant === 'centered' && (isAuthenticated || isAuthLoading));
      ...
      >
        ...
        >
          <main
            className={clsx(
              'chat-container',
              promptVariant === 'bottom' && 'chat-container--fixed-prompt'
            )}
          >
            {conversation.isInitialized ? (
              <ChatView
            ...
            {shouldRenderCenteredPrompt ? (
              <AppPromptComposer {...promptComposerProps} variant="centered" />
            ) : null}
          </main>
        </div>

        {conversation.isInitialized ? (
          <AppPromptComposer {...promptComposerProps} variant="bottom" />
        ) : null}
