...
const QuickSearchDialog = lazy(() =>
  import('../components/modals/QuickSearchDialog').then((m) => ({ default: m.QuickSearchDialog }))
);
const ReportIssueModal = lazy(() => import('../components/modals/ReportIssueModal'));
const ComputerTheater = lazy(() =>
  import('../components/chat/ComputerTheater').then((m) => ({ default: m.ComputerTheater }))
);
const DesktopAgentManagerPanel = lazy(() =>
  import('./DesktopAgentManagerPanel').then((m) => ({ default: m.DesktopAgentManagerPanel }))
);
...
export interface AppShellOverlaysProps {
  ...
  reportIssueContext: { conversationId?: string | null; lastMessagePreview?: string };
