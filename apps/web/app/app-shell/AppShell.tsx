...
import { createComputerTheaterPreScreenStatus } from '@taskforceai/shared';
...
export const AppShell: React.FC<AppShellProps> = ({ modelSelectorBootstrap }) => {
  ...
  const canUseCenteredPromptBeforeRestore =
    promptVariant === 'centered' && messages.length === 0 && isAuthenticated;
