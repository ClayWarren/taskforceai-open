...
import { DESKTOP_APP_SERVER_AUTH_CHANGED_EVENT } from '../lib/platform/desktop/auth-events';
...
describe('useAppShellNavigationActions', () => {
  ...
  it('adds desktop hints to malformed device login URLs and handles slow-down polling', async () => {
    ...
    await waitFor(() => expect(pollDesktopAppServerDeviceLogin).toHaveBeenCalledTimes(2));
    expect(reload).not.toHaveBeenCalled();
