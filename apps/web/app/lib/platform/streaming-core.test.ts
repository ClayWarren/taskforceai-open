...
describe('resolveStreamUrl', () => {
  ...
  it('handles uppercase protocol and host when detecting TaskForce web origins', () => {
    expect(
      resolveStreamUrl('task-upper', 'HTTPS://WWW.TASKFORCEAI.CHAT', 'HTTPS://WWW.TASKFORCEAI.CHAT')
    ).toBe('https://engine.taskforceai.chat/api/v1/stream/task-upper');
  });
