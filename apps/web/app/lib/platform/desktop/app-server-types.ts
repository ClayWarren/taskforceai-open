...
export type AppServerVoiceTranscribeParams = {
  audioBase64: string;
  mediaType: string;
  fileName?: string | null;
};
export type AppServerVoiceTranscribeResult = {
  text: string;
};
export type AppServerVoiceSpeechGenerateParams = {
  text: string;
};
export type AppServerVoiceSpeechGenerateResult = {
  audioBase64: string;
  mediaType: string;
  format?: string | null;
};
export type AppServerVoiceRealtimeSetupParams = {
  sessionConfig?: unknown;
};
export type AppServerVoiceRealtimeSetupResult = {
  token: string;
  url: string;
