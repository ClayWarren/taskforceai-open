...
export type DesktopCodePinnedSummaryProps = {
...
export type DesktopWorkspaceMentionMenuProps = {
  query: string;
  onSelect: (_path: string) => void;
};
export type DesktopWorkspaceTargetSelectorProps = {
...
export interface DesktopUiIntegration {
  ...
  CodePinnedSummary: ComponentType<DesktopCodePinnedSummaryProps>;
  ...
  WorkspaceMentionMenu: ComponentType<DesktopWorkspaceMentionMenuProps>;
  WorkspaceTargetSelector: ComponentType<DesktopWorkspaceTargetSelectorProps>;
...
export const DesktopCodePinnedSummary = (props: DesktopCodePinnedSummaryProps) => (
  <desktopUi.CodePinnedSummary {...props} />
);
...
export const DesktopWorkspaceMentionMenu = (props: DesktopWorkspaceMentionMenuProps) => (
  <desktopUi.WorkspaceMentionMenu {...props} />
);
export const DesktopWorkspaceTargetSelector = (props: DesktopWorkspaceTargetSelectorProps) => (
  <desktopUi.WorkspaceTargetSelector {...props} />
);
