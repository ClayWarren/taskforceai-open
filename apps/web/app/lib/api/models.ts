...
import { fetchModelOptions as baseFetchModels } from '@taskforceai/contracts/utils/models';

import { logger as defaultLogger } from '../logger';
import { type Result, err, ok } from '@taskforceai/shared/result';
import { getServerBaseUrl, readStatusCode } from '@taskforceai/shared/utils/api';
...
export const fetchModelOptions = async ({
  ...
  logger?: typeof defaultLogger | null;
