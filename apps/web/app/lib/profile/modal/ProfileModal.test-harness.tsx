...
void vi.mock('../../platform/desktop-api', () => ({
  inspectDesktopMcpServer: mockInspectDesktopMcpServer,
  waitForTauriBridge: mockWaitForTauriBridge,
  invokeTauri: mockInvokeTauri,
  updateDesktopAppServerLocalSettings: (settings: unknown) =>
    mockInvokeTauri('app_server_local_settings_update', { params: settings }),
}));

void vi.mock('../../platform/desktop-ui', () => ({
  PairingSections: () => <span>Pairing settings</span>,
