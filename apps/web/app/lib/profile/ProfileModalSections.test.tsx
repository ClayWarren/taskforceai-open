...
describe('ProfileModalSections', () => {
  ...
  describe('UsageLimitsSection', () => {
    ...
    it('renders capped weekly usage and model multipliers', () => {
      renderUsage();

      expect(screen.getByText('Plan usage limits')).toBeDefined();
      expect(screen.getByText('Free')).toBeDefined();
      expect(screen.getByText('Weekly messages')).toBeDefined();
      ...
      expect(screen.getByRole('progressbar', { name: 'Weekly messages' })).toHaveAttribute(
        'aria-valuenow',
        '100'
      );
    ...
    it('renders paid throughput when no hard weekly cap is available', () => {
      ...
      expect(screen.getByText('2 messages per hour')).toBeDefined();
      expect(screen.getByText('42 messages used')).toBeDefined();
