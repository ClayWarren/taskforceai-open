...
import { DesktopProjectsSidebar, type DesktopUpdateAction } from '../../lib/platform/desktop-ui';
import type { DesktopTaskMode } from '../../lib/desktop/task-mode';
import type { ConversationActivity } from '../chat/conversation-activity';
      ...
      <div className="sidebar-logo-bar flex items-center gap-3">
        {desktopTaskShell ? (
          ...
          <>
            ...
            <button
              type="button"
              className="rounded-md p-2 text-slate-300 transition hover:bg-white/[0.07] hover:text-white"
              aria-label="Close sidebar"
              onClick={props.onClose}
            >
