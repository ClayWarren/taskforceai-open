...
export function ProjectsPage() {
  ...
  const visibleProjects = useMemo(
    () => filterProjects(projects, searchQuery, filter),
  ...
  return (
    <section className="mx-auto flex min-h-screen w-full max-w-5xl flex-col px-4 pt-24 pb-16 sm:px-8 lg:pt-32">
      <div className="mx-auto w-full max-w-3xl">
        ...
        <div className="mt-12 flex items-center gap-2 border-b border-white/10 pb-4">
          {(
            [
              ['all', 'All'],
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          {isAuthLoading || isLoading ? (
            ...
            <ProjectsState
              message={
                searchQuery.trim() || filter === 'shared' ? 'No projects found' : 'No projects yet'
              }
            />
          ) : (
