...
export const PromptActions: React.FC<PromptActionsProps> = ({
  ...
  const realtimeVoiceTooltipLabel = realtimeVoiceActive ? 'End Voice Chat' : 'Use Voice';
        ...
        {isListening ? (
          ...
          <>
            <Tooltip>
              ...
              {primaryButtonMode === 'voice' ? (
                <TooltipContent side="top" className="prompt-control-tooltip">
                  <PromptControlTooltip
                    label={dictationTooltipLabel}
                    shortcut={PROMPT_SHORTCUTS.dictate}
                  />
                </TooltipContent>
              ) : null}
            </Tooltip>
            <Tooltip>
              ...
              <TooltipContent side="top" className="prompt-control-tooltip">
                <PromptControlTooltip
                  label={realtimeVoiceTooltipLabel}
                  shortcut={PROMPT_SHORTCUTS.voice}
                />
              </TooltipContent>
            </Tooltip>
          </>
