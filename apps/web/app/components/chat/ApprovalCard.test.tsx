...
describe('ApprovalCard', () => {
  ...
  it('remembers an exact approval rule for the current task session', async () => {
    render(<ApprovalCard {...baseProps} />);
  ...
  it('automatically approves a matching remembered rule', async () => {
    sessionStorage.setItem('taskforceai.approval.v1:task-123:read_file:*.txt', 'approved');
