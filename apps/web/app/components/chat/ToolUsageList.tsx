...
import { buildToolUsageViewItems } from '@taskforceai/shared/tool-usage/view-model';
      ...
      <ul className="tool-usage__list">
        {items.map((item) => {
          ...
          return (
            ...
            >
              <div
                className={`tool-usage__summary ${searchEvent ? 'tool-usage__summary--search' : ''}`}
              >
                {searchEvent ? (
                  <>
                ...
                {item.durationLabel && (
                  <span className="tool-usage__duration">{item.durationLabel}</span>
                )}
                {codeExecution && (
                  <button
                    type="button"
