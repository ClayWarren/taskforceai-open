...
CREATE UNIQUE INDEX "remote_targets_user_id_device_id_key"
    ON "remote_targets"("user_id", "device_id");
CREATE INDEX "remote_targets_user_id_idx" ON "remote_targets"("user_id");
CREATE UNIQUE INDEX "remote_connections_user_id_target_device_id_controller_device_id_key"
    ON "remote_connections"("user_id", "target_device_id", "controller_device_id");
