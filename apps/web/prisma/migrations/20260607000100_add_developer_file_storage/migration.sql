...
CREATE TABLE IF NOT EXISTS "developer_files" (
    ...
    CONSTRAINT "developer_files_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations" (
        "id"
    ) ON DELETE SET NULL ON UPDATE CASCADE
);

CREATE UNIQUE INDEX IF NOT EXISTS "developer_files_blob_url_key" ON "developer_files" ("blob_url");
CREATE UNIQUE INDEX IF NOT EXISTS "developer_files_blob_path_key" ON "developer_files" ("blob_path");
CREATE INDEX IF NOT EXISTS "developer_files_user_id_created_at_idx" ON "developer_files" ("user_id", "created_at" DESC);
CREATE INDEX IF NOT EXISTS "developer_files_user_id_deleted_at_idx" ON "developer_files" ("user_id", "deleted_at");
