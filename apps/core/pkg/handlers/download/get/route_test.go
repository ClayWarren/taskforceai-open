...
func TestDownloadHandler_InvalidRequest(t *testing.T) {
	...
	router := setupDownloadRouter(service)
	handlertest.ServeStatus(t, router, http.StatusBadRequest, http.MethodGet, "/api/download/cli/bad/latest")
}
...
func TestDownloadHandler_NotFound(t *testing.T) {
	...
	router := setupDownloadRouter(service)
	handlertest.ServeStatus(t, router, http.StatusNotFound, http.MethodGet, "/api/download/cli/macos/latest")
}
...
func TestDownloadHandler_ServiceUnavailable(t *testing.T) {
	...
	router := setupDownloadRouter(service)
	handlertest.ServeStatus(t, router, http.StatusInternalServerError, http.MethodGet, "/api/download/cli/macos/latest")
}
