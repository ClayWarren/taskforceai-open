...
type CreateConversationRequest struct {
	Title         string  `json:"title" minLength:"1" maxLength:"200" doc:"Title or user input for the conversation"`
	Result        *string `json:"result,omitempty" maxLength:"2000" doc:"Initial result content"`
...
type UpdateConversationRequest struct {
	...
	Result        *string `json:"result,omitempty" maxLength:"2000"`
