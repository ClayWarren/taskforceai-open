...
func TestDesktopUpdate_MissingToken(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/desktop/update/darwin/1.0.0", nil)
...
func TestDesktopUpdate_Success(t *testing.T) {
	...
	router := setupUpdateRouter(t)
	req := httptest.NewRequest(http.MethodGet, "/api/desktop/update/darwin-x86_64/1.0.0", nil)
	resp := httptest.NewRecorder()
	router.ServeHTTP(resp, req)
...
func TestDesktopUpdate_CacheHitCanonicalizesArtifactVersion(t *testing.T) {
	...
	router := setupUpdateRouter(t, cache)
	req := httptest.NewRequest(http.MethodGet, "/api/desktop/update/darwin-aarch64/0.4.15", nil)
	resp := httptest.NewRecorder()
	router.ServeHTTP(resp, req)
...
func TestDesktopUpdate_CacheHitReturnsNoContentForCurrentVersion(t *testing.T) {
	...
	router := setupUpdateRouter(t, cache)
	req := httptest.NewRequest(http.MethodGet, "/api/desktop/update/darwin-x86_64/1.2.3", nil)
	resp := httptest.NewRecorder()
	router.ServeHTTP(resp, req)
...
func TestDesktopUpdate_LinuxArm64ArtifactsDoNotPoisonX64Updates(t *testing.T) {
	...
	x64Req := httptest.NewRequest(http.MethodGet, "/api/desktop/update/linux-x86_64/1.0.0", nil)
	x64Resp := httptest.NewRecorder()
	router.ServeHTTP(x64Resp, x64Req)

	require.Equal(t, http.StatusOK, x64Resp.Code)
	...
	arm64Req := httptest.NewRequest(http.MethodGet, "/api/desktop/update/linux-aarch64/1.0.0", nil)
	arm64Resp := httptest.NewRecorder()
	router.ServeHTTP(arm64Resp, arm64Req)

	require.Equal(t, http.StatusOK, arm64Resp.Code)
...
func TestDesktopUpdate_CacheHitRejectsTargetMismatchedArtifact(t *testing.T) {
	...
	router := setupUpdateRouter(t, cache)
	req := httptest.NewRequest(http.MethodGet, "/api/desktop/update/linux-x86_64/1.0.0", nil)
	resp := httptest.NewRecorder()
	router.ServeHTTP(resp, req)
...
func TestDesktopUpdate_UnsupportedTarget(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/desktop/update/unknown-platform/1.0.0", nil)
	resp := httptest.NewRecorder()
	router.ServeHTTP(resp, req)
...
func TestDesktopUpdate_InvalidVersion(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/desktop/update/darwin-x86_64/latest", nil)
	resp := httptest.NewRecorder()
	router.ServeHTTP(resp, req)
