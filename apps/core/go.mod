module github.com/TaskForceAI/go-core
...
require (
	...
	github.com/TaskForceAI/contracts v0.0.0-00010101000000-000000000000
	github.com/TaskForceAI/feature-flags v0.0.0
...
require go.opentelemetry.io/otel/trace v1.44.0 // indirect
