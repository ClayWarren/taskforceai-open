...
func (a memoryStoreAdapter) GetUserMemories(ctx context.Context, userID int32) ([]memoriespkg.MemoryRecord, error) {
	memories, err := a.q.GetUserMemories(ctx, userID)
	if err != nil {
		return nil, err
	}
	return mapMemoryRecords(memories), nil
}

func (a memoryStoreAdapter) GetUserMemoriesWithOrg(ctx context.Context, input memoriespkg.GetUserMemoriesWithOrgInput) ([]memoriespkg.MemoryRecord, error) {
	memories, err := a.q.GetUserMemoriesWithOrg(ctx, db.GetUserMemoriesWithOrgParams{
		UserID:         input.UserID,
		OrganizationID: input.OrganizationID,
	})
	if err != nil {
...
func (a memoryStoreAdapter) DeleteMemory(ctx context.Context, input memoriespkg.DeleteMemoryInput) error {
...
func (a memoryStoreAdapter) DeleteMemoryWithOrg(ctx context.Context, input memoriespkg.DeleteMemoryWithOrgInput) error {
...
func (a memoryStoreAdapter) CreateMemory(ctx context.Context, input memoriespkg.CreateMemoryInput) error {
...
func (a memoryStoreAdapter) UpdateMemory(ctx context.Context, input memoriespkg.UpdateMemoryStoreInput) (memoriespkg.MemoryRecord, error) {
	memory, err := a.q.UpdateMemory(ctx, db.UpdateMemoryParams{
		ID:       input.ID,
		UserID:   input.UserID,
		Content:  input.Content,
		Type:     input.Type,
	...
	if err != nil {
		return memoriespkg.MemoryRecord{}, err
	}
	return mapMemoryRecord(memory), nil
}

func (a memoryStoreAdapter) UpdateMemoryWithOrg(ctx context.Context, input memoriespkg.UpdateMemoryWithOrgStoreInput) (memoriespkg.MemoryRecord, error) {
	memory, err := a.q.UpdateMemoryWithOrg(ctx, db.UpdateMemoryWithOrgParams{
		ID:             input.ID,
		UserID:         input.UserID,
		OrganizationID: input.OrganizationID,
		Content:        input.Content,
...
func mapMemoryRecords(memories []db.Memory) []memoriespkg.MemoryRecord {
	return collections.Map(memories, mapMemoryRecord)
}

func mapMemoryRecord(memory db.Memory) memoriespkg.MemoryRecord {
	return memoriespkg.MemoryRecord{
		ID:             memory.ID,
		...
		CreatedAt:      pgTimestampString(memory.CreatedAt),
		UpdatedAt:      pgTimestampString(memory.UpdatedAt),
	}
}

func pgTimestampString(ts pgtype.Timestamp) string {
	if !ts.Valid {
		return ""
	}
...
func (a conversationShareQueriesAdapter) UpdateConversationSharing(ctx context.Context, input conversations.UpdateConversationSharingInput) (conversations.SharedConversation, error) {
	conversation, err := a.q.UpdateConversationSharing(ctx, db.UpdateConversationSharingParams{
		ID:       input.ID,
...
func (a conversationShareQueriesAdapter) UpdateConversationSharingWithOrg(ctx context.Context, input conversations.UpdateConversationSharingWithOrgInput) (conversations.SharedConversation, error) {
	conversation, err := a.q.UpdateConversationSharingWithOrg(ctx, db.UpdateConversationSharingWithOrgParams{
		ID:             input.ID,
		IsPublic:       input.IsPublic,
		ShareID:        input.ShareID,
		UserID:         input.UserID,
...
func (a publicShareQueriesAdapter) GetConversationByShareID(ctx context.Context, shareID *string) (publicshare.SharedConversation, error) {
	conversation, err := a.q.GetConversationByShareID(ctx, shareID)
	if err != nil {
	...
	return publicshare.SharedConversation{
		...
		PublicSharedAt:    conversation.PublicSharedAt.Time,
		HasPublicSharedAt: conversation.PublicSharedAt.Valid,
	}, nil
}
...
func (a publicShareQueriesAdapter) GetPublicMessagesByConversationID(ctx context.Context, input publicshare.PublicMessagesInput) ([]publicshare.PublicMessageRow, error) {
	messages, err := a.q.GetPublicMessagesByConversationID(ctx, db.GetPublicMessagesByConversationIDParams{
		ConversationID: input.ConversationID,
		PublicSharedAt: pgtype.Timestamp{Time: input.PublicSharedAt, Valid: true},
	})
	if err != nil {
		return nil, err
	}

	return collections.Map(messages, func(message db.GetPublicMessagesByConversationIDRow) publicshare.PublicMessageRow {
...
func (a gdprStoreAdapter) DeleteUser(ctx context.Context, userID int32) error {
	return a.q.DeleteUser(ctx, userID)
}
