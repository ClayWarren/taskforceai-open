...
const keyResults = [
  "Sentinel is TaskForceAI's model, shown with current benchmark results sourced from Artificial Analysis.",
  'Grok 4.3 is now included alongside GPT-5.5, Gemini 3.1 Pro Preview, and Claude Fable 5.',
  'Artificial Analysis Index v4.0 aggregates 10 reasoning, agentic, coding, and knowledge evaluations.',
];
      ...
      <article className="mx-auto max-w-5xl py-16">
        <header className="mb-12">
          ...
          <p className="mb-4 text-xs font-bold tracking-[0.3em] text-blue-400 uppercase">
            Benchmarks · Updated June 3, 2026
          </p>
        ...
        <div className="mt-16 space-y-16">
          <section className="space-y-6">
            ...
            <div className="space-y-4 text-lg leading-relaxed text-slate-600 dark:text-slate-400">
              <p>
                These values come from Artificial Analysis model leaderboards and their Intelligence
                Index v4.0 breakdown. The index incorporates evaluations including GDPval-AA,
                Tau-Bench Telecom, Terminal-Bench Hard, SciCode, AA-LCR, AA-Omniscience, IFBench,
                Humanity&apos;s Last Exam, GPQA Diamond, and CritPt.
              </p>
              <p>
                Sentinel is TaskForceAI&apos;s model. TaskForceAI&apos;s multi-agent orchestration
                layer is evaluated separately and should not be inferred directly from these model
                benchmark numbers.
              </p>
            </div>
          </section>
