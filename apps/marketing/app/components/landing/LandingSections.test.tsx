...
describe('Landing sections', () => {
  ...
  it('renders optional secondary surface CTAs and applies default CTA props', () => {
    ...
    const { container } = render(<SurfacesSection surfaces={surfaces} />);

    const gradientLayer = container.querySelector<HTMLElement>('article > div.pointer-events-none');
    expect(gradientLayer?.style.backgroundImage).toContain('rgba(56, 189, 248, 0.4)');
