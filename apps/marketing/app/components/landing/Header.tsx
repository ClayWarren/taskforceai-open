                  ...
                  <li key={link.href}>
                    {link.href.startsWith('#') ? (
                      <a
                        ...
                        className="block cursor-pointer px-4 py-3 text-slate-800 no-underline hover:bg-slate-900/5 hover:text-slate-900 dark:text-slate-200 dark:hover:bg-white/5 dark:hover:text-white"
                        role="menuitem"
                      >
                        {link.label}
                      </a>
