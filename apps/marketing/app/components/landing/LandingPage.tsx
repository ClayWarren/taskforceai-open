...
const surfaces: SurfaceCardConfig[] = [
  {
    ...
    accent: 'rgba(59, 130, 246, 0.4) 0%, rgba(96, 165, 250, 0.1) 55%, transparent 100%',
  },
  {
    name: 'Desktop',
    description:
    ...
    accent: 'rgba(168, 85, 247, 0.4) 0%, rgba(192, 132, 252, 0.1) 55%, transparent 100%',
  },
  {
    name: 'Mobile',
    description:
    ...
    accent: 'rgba(6, 182, 212, 0.4) 0%, rgba(34, 211, 238, 0.1) 55%, transparent 100%',
  },
];
        ...
        <section id="benchmarks" aria-labelledby="benchmarks-heading" className="space-y-10">
          <div className="mx-auto flex max-w-3xl flex-col gap-4 text-center">
            ...
            <p className="text-base text-slate-700 md:text-lg dark:text-slate-300">
              ...
              Preview, Claude Fable 5 (with fallback), and Grok 4.5 (high) using current Artificial
