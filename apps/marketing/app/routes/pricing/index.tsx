...
const pricingTiers = [
  {
    ...
    requests: '50 messages / month',
    rateLimit: '1 credit per week',
    concurrency: '1',
    features: ['1 task credit per week', 'Access to standard models'],
    cta: 'Get Started',
  ...
  },
  {
    ...
    requests: 'Unlimited messages',
    rateLimit: '20 task credits / hour',
...
const modelMultipliers = [
  ...
  { model: 'GPT 5.6 Sol', multiplier: '3×' },
  { model: 'GPT 5.6 Terra', multiplier: '2×' },
  { model: 'GPT 5.6 Luna', multiplier: '1×' },
  { model: 'Gemini 3.1 Pro', multiplier: '1×' },
  { model: 'Claude Fable 5', multiplier: '2×' },
  { model: 'Grok 4.5', multiplier: '2×' },
];
