...
import {
  sdkAdvancedUsageSnippet,
  sdkBasicUsageSnippet,
  sdkBrowserUsageSnippet,
  sdkClientInitializationSnippet,
  sdkErrorHandlingSnippet,
} from '@/help-data/sdk-snippets';
          ...
          <div className="mx-auto max-w-4xl rounded-3xl border border-slate-200 bg-white/60 p-8 md:p-12 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-12">
              ...
              <p className="mt-4 text-sm text-slate-500">
                Requires Node.js 24.13+ when running under Node for native{' '}
