...
const APP_STORE_FALLBACK_URL = 'https://apps.apple.com/us/app/taskforceai/id6754827533';
...
vi.mock('@/lib/mobile-links', () => ({
  resolveMobileIosUrl: (candidateUrl?: string) => {
    ...
    if (
      ...
      normalizedUrl.startsWith('https://testflight.apple.com/')
    ) {
...
describe('Marketing routes: about/mobile/sdk/company/enterprise/blog', () => {
  ...
  it('renders standalone benchmarks page with benchmark table and methodology', () => {
    ...
    expect(screen.getByText('Grok 4.3 (high)')).toBeTruthy();
