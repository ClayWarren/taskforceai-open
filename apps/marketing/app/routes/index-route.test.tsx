...
const redirects: Array<{ statusCode?: number; to: string }> = [];
...
vi.mock('@unpic/react', () => ({
  Image: ({
    ...
    preload: _preload,
    ...props
  }: React.ComponentProps<'img'> & { layout?: string; priority?: boolean; preload?: boolean }) => (
    <img alt={alt} {...props} />
  ),
}));
...
describe('Index and home routes', () => {
  it('redirects the root path to the marketing home route', () => {
    ...
    expect(redirects).toEqual([{ to: '/home', statusCode: 308 }]);
  });
