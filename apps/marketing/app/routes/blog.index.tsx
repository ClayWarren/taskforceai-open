...
const description = 'Updates, research notes, and announcements from the TaskForceAI team.';
      ...
      <div className="mx-auto max-w-4xl py-16">
        ...
        <section className="mb-14 rounded-3xl border border-slate-200 bg-white/70 p-6 shadow-xl dark:border-slate-800 dark:bg-slate-900/40">
          ...
          <p className="mt-4 text-base leading-relaxed text-slate-600 dark:text-slate-400">
            Current Artificial Analysis comparisons for Sentinel, GPT-5.5, Gemini 3.1 Pro Preview,
            Claude Fable 5, and Grok 4.3.
          </p>
          <Link
            to="/benchmarks"
