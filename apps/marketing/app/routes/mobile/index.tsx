...
const description =
  'Install TaskForceAI beta builds for iOS and Android and learn how mobile updates ship.';
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-16 py-16">
        <header className="space-y-6 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg leading-relaxed text-slate-600 dark:text-slate-400">
            Join the beta builds today and receive hotfixes automatically via Expo Application
            Services (EAS) updates. When the public store listings go live, these links will
            redirect to the App Store and Google Play.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <DownloadLink
              ...
              description={
                isExternalHref(iosDownloadUrl) ? 'Opens TestFlight' : 'Beta link coming soon'
              }
            />
            <DownloadLink
              ...
              description={
                isExternalHref(androidDownloadUrl) ? 'Opens Play Console' : 'Beta link coming soon'
              }
            />
          </div>
        </header>
        ...
        <div className="grid gap-8">
          <Section
            id="ios-install"
            title="iOS TestFlight setup"
            description="Enroll devices with your Apple ID to access internal testing builds."
          >
            <StepList
              steps={[
                'Install the TestFlight app from the App Store on your iPhone or iPad.',
                'Open the TaskForceAI TestFlight invite link above and accept the beta agreement.',
                'Tap “Install” in TestFlight to download the latest build and enable automatic updates.',
                'Optional: share device UDIDs with the team for direct ad-hoc builds if TestFlight is unavailable.',
              ]}
            />
          </Section>
