...
const defaultIosDownloadUrl = resolveMobileIosUrl(env.NEXT_PUBLIC_MOBILE_IOS_APP_URL);
const defaultAndroidDownloadUrl = resolveMobileAndroidUrl(env.NEXT_PUBLIC_MOBILE_ANDROID_APP_URL);
...
export function MobilePage({
  iosDownloadUrl = defaultIosDownloadUrl,
  androidDownloadUrl = defaultAndroidDownloadUrl,
}: {
