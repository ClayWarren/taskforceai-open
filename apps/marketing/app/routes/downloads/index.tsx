...
const description = 'Download TaskForceAI desktop apps, mobile apps, CLI, and developer SDKs.';
...
import { MOBILE_IOS_APP_STORE_URL } from '@/lib/mobile-links';
      ...
      <div className="flex flex-col gap-24 py-16">
              ...
              downloads={[
                {
                  ...
                  note: 'Universal AppImage for x64 systems',
                  primary: true,
                },
                {
                  label: 'Download .deb (x64)',
                  href: 'https://taskforceai.chat/api/download/desktop/linux-deb/latest',
                  note: 'Debian/Ubuntu x64 package',
                },
                {
                  label: 'Download AppImage (ARM64)',
                  href: 'https://taskforceai.chat/api/download/desktop/linux-arm64/latest',
                  note: 'Universal AppImage for ARM64 systems',
                },
                {
                  label: 'Download .deb (ARM64)',
                  href: 'https://taskforceai.chat/api/download/desktop/linux-arm64-deb/latest',
                  note: 'Debian/Ubuntu ARM64 package',
                },
              ]}
            />
          </div>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white/60 p-8 md:p-12 dark:border-slate-800 dark:bg-slate-900/40">
          ...
          <div className="grid gap-8">
            <InstallCommand
              ...
              command="curl -fsSL https://taskforceai.chat/install.sh | bash"
            />
            <InstallCommand
            ...
            <InstallCommand
              ...
              command="irm https://taskforceai.chat/install.ps1 | iex"
            />
          </div>
        </section>
        ...
        <section className="py-12 text-center">
          ...
          <p className="mx-auto mb-10 max-w-xl text-lg text-slate-600 dark:text-slate-400">
            Take TaskForceAI with you on iOS and Android. Download the iOS app from the App Store or
            join the Android beta for early access.
          </p>

          <div className="flex flex-wrap justify-center gap-4">
            <a
              href={MOBILE_IOS_APP_STORE_URL}
              target="_blank"
        ...
        <section>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <SDKCard
              ...
              description="For Bun and Node.js 24.13+ server applications"
            />
            <SDKCard
              language="Python"
              command="python -m pip install taskforceai"
              description="For Python 3.10+"
            />
            <SDKCard
              language="Go"
              command="go get github.com/ClayWarren/taskforceai-open/packages/sdk-go"
              description="For Go 1.26.4+"
            />
            <SDKCard
              language="Rust"
              command="cargo add taskforceai-sdk"
              description="For Rust 1.96+"
            />
          </div>
        </section>
      </div>
