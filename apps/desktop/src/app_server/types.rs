...
use taskforceai_app_protocol::ThreadRecord;
use thiserror::Error;
...
pub enum DesktopThreadLocation {
    Local,
    Remote,
}
...
#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct DesktopThreadHandoffParams {
    pub thread_id: String,
    pub source: DesktopThreadLocation,
    pub target: DesktopThreadLocation,
}

#[derive(Debug, Clone, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct DesktopThreadHandoffResult {
