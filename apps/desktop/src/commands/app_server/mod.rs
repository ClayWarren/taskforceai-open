...
use taskforceai_app_protocol::{
    ...
    GitReviewDiffParams, GitReviewDiffResult, GitReviewStatusParams, GitReviewStatusResult,
    HybridModeResult, InitializeResult, LocalSettingsResult, LocalSettingsUpdateParams,
    MemorySummaryResult, MessageIDParams, ModelListResult, PendingChangeListResult, PetResult,
    PetSetParams, PluginListResult, QuickModeResult, RunIDParams, RunStatusResult,
...
create a file"
    ...
    fn local_coding_agent_session_run_enrichment_uses_fallback_prompt() {
        ...
        let enriched = enrich_local_coding_agent_session_run_params(
            params,
            std::path::Path::new("/tmp/session-workspace"),
        ...
        assert!(prompt.contains("workspace `/tmp/session-workspace`"));
...
Fix the failing test"
    ...
    fn local_coding_turn_start_enrichment_prefixes_input_and_dedupes_tools() {
        ...
        let enriched =
            enrich_local_coding_turn_start_params(params, std::path::Path::new("/tmp/thread"));

        assert!(enriched.input.contains("workspace `/tmp/thread`"));
