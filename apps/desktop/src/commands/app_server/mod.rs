...
use taskforceai_app_protocol::{
    ...
    ChannelResult, ComputerUseStatusResult, ContextSummaryResult, ConversationIDParams,
    ...
    GitReviewCommentListResult, GitReviewCommentResolveParams, GitReviewCommentResult,
    GitReviewDiffParams, GitReviewDiffResult, GitReviewPullRequestActionParams,
    GitReviewStageParams, GitReviewStatusParams, GitReviewStatusResult, HybridModeResult,
    InitializeResult, LocalSettingsResult, LocalSettingsUpdateParams, MemorySummaryResult,
    MessageIDParams, ModelListResult, PendingChangeListResult, PetResult, PetSetParams,
    PluginListResult, QuickModeResult, RemoteControllerListResult, RemoteControllerRevokeParams,
    RemotePairingCodeResult, RunIDParams, RunStatusResult, ScheduleAddParams, ScheduleIDParams,
    ScheduleListResult, ScheduleResult, ScheduleTickParams, ScheduleTickResult, SkillListResult,
    StatusSummaryResult, SyncDeviceResult, SyncStatusResult, ThreadIDParams, ThreadListResult,
    ThreadResult, TurnInterruptParams, TurnResult, TurnSteerParams, VoiceRealtimeSetupParams,
    VoiceRealtimeSetupResult, VoiceSpeechGenerateParams, VoiceSpeechGenerateResult,
    VoiceTranscribeParams, VoiceTranscribeResult,
};
...
Fix the failing test"
    ...
    fn local_coding_turn_start_enrichment_prefixes_input_and_dedupes_tools() {
        ...
        assert!(enriched.input.contains("workspace roots:"));
