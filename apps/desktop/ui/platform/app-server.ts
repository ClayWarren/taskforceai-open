...
import type {
  ...
  AppServerApiRequestParams,
  AppServerApiRequestResult,
  ...
  DesktopWorktreeResetParams,
  DesktopWorktreeRemoveParams,
  DesktopWorktreeActionResult,
...
export const getDesktopTerminalLaunchConfig = (params: TerminalLaunchParams = {}) =>
  invokeTauri<TerminalLaunchConfig>('terminal_launch_config', { params });
...
export const resetDesktopWorktree = (params: DesktopWorktreeResetParams) =>
  invokeWithParams<DesktopWorktreeActionResult>('desktop_worktree_reset', params);

export const removeDesktopWorktree = (params: DesktopWorktreeRemoveParams) =>
  invokeWithParams<DesktopWorktreeActionResult>('desktop_worktree_remove', params);

export const captureDesktopWorkspaceCheckpoint = (
  params: DesktopWorkspaceCheckpointCaptureParams
) =>
  invokeWithParams<DesktopWorkspaceCheckpointResult>(
    'desktop_workspace_checkpoint_capture',
    params
  );
...
export const restoreDesktopWorkspaceCheckpoint = (
  ...
  invokeWithParams<DesktopWorkspaceCheckpointResult>(
    'desktop_workspace_checkpoint_restore',
    params
  );
...
export const requestDesktopAppServerApi = (params: AppServerApiRequestParams) =>
  invokeWithParams<AppServerApiRequestResult>('app_server_api_request', params);
...
export const listDesktopProcesses = () => invokeTauri<ProcessListResult>('app_server_process_list');

export const startDesktopProcess = (params: ProcessStartParams) =>
  invokeWithParams<ProcessResult>('app_server_process_start', params);

export const readDesktopProcess = (params: ProcessReadParams) =>
  invokeWithParams<ProcessReadResult>('app_server_process_read', params);

export const writeDesktopProcess = (params: ProcessWriteParams) =>
  invokeWithParams<ProcessResult>('app_server_process_write', params);

export const resizeDesktopProcess = (params: ProcessResizeParams) =>
  invokeWithParams<ProcessResult>('app_server_process_resize', params);

export const killDesktopProcess = (processId: string) =>
  invokeWithParams<ProcessResult>('app_server_process_kill', { processId });
