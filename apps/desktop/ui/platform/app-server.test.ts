...
describe('desktop app-server bridge', () => {
  ...
  it('invokes status through the shared app-server command', async () => {
    ...
    await captureDesktopWorkspaceCheckpoint({ conversationId: 'conversation-1' });
    ...
    expectTauriCalls(
      ...
      ['desktop_workspace_checkpoint_capture', { params: { conversationId: 'conversation-1' } }],
      [
        'desktop_workspace_checkpoint_restore',
        { params: { conversationId: 'conversation-1', beforeTimestamp: 42 } },
      ],
