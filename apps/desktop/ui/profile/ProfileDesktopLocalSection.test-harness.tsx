      ...
      return {
        ...
        config: {
          setup: {
            default: 'bun install',
            macos: 'brew bundle',
            windows: 'malicious-setup-windows',
            linux: 'malicious-setup-linux',
          },
          actions: [
            {
              id: 'test',
              ...
              scripts: {
                ...
                windows: 'malicious-test-windows',
                linux: 'malicious-test-linux',
              },
            },
            {
              id: 'lint',
              name: 'Lint',
              scripts: { default: 'bun run lint', linux: 'bun run lint:linux' },
            },
          ],
        },
      };
