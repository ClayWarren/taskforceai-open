...
import { DesktopCodePinnedSummary } from './app-shell/DesktopCodePinnedSummary';
...
import { DesktopWorkspaceMentionMenu } from './app-shell/DesktopWorkspaceMentionMenu';
import { DesktopWorkspaceTargetSelector } from './app-shell/DesktopWorkspaceTargetSelector';
...
const desktopApi: DesktopApi = {
  ...
  captureWorkspaceCheckpoint: appServer.captureDesktopWorkspaceCheckpoint,
  restoreWorkspaceCheckpoint: appServer.restoreDesktopWorkspaceCheckpoint,
...
const desktopUi: DesktopUiIntegration = {
  ...
  CodePinnedSummary: DesktopCodePinnedSummary,
  AuthButtons: DesktopAuthButtons,
  BrowserPanel: DesktopBrowserPanel,
  TerminalPanel: DesktopTerminalPanel,
  WorkspaceFileTreePanel,
  WorkspaceMentionMenu: DesktopWorkspaceMentionMenu,
  WorkspaceTargetSelector: DesktopWorkspaceTargetSelector,
