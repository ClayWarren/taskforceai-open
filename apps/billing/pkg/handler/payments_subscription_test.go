...
func TestCheckoutHandler_UserNotAuthenticated(t *testing.T) {
	...
	restore(t, &auth_handler.MarketingBaseURL)
	auth_handler.MarketingBaseURL = "https://marketing.example.com"
	restore(t, &auth_handler.WebBaseURL)
	auth_handler.WebBaseURL = "https://app.example.com"
	...
	assert.Equal(
		t,
		"https://app.example.com/login?plan=pro&callbackUrl=%2Fapi%2Fv1%2Fcheckout%3Fplan%3Dpro",
