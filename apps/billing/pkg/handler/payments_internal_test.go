...
func TestBuildSubscriptionCheckoutParams_UsesStablePerUserPriceIdempotency(t *testing.T) {
	first := buildSubscriptionCheckoutParams(42, "cus_123", "price_pro", "https://example.com/success", "https://example.com/cancel")
	retry := buildSubscriptionCheckoutParams(42, "cus_123", "price_pro", "https://example.com/success", "https://example.com/cancel")
	otherPrice := buildSubscriptionCheckoutParams(42, "cus_123", "price_super", "https://example.com/success", "https://example.com/cancel")
