...
func reportBillingLatencyProfile(b *testing.B, samples []time.Duration) {
	...
	b.ReportMetric(billingDurationMicroseconds(benchtest.PercentileDuration(ordered, 0.50)), "p50_us")
	b.ReportMetric(billingDurationMicroseconds(benchtest.PercentileDuration(ordered, 0.95)), "p95_us")
	b.ReportMetric(billingDurationMicroseconds(benchtest.PercentileDuration(ordered, 0.99)), "p99_us")
}
