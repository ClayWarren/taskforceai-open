...
func NewPaymentsRepository(q *db.Queries) *PgPaymentsRepository {
	return &PgPaymentsRepository{store: sqlcBillingStore{q: q}}
}

func NewAccountSettingsRepository(q *db.Queries) *PgAccountSettingsRepository {
	return &PgAccountSettingsRepository{store: sqlcBillingStore{q: q}}
}

func (r *PgPaymentsRepository) FindUserByID(ctx context.Context, userID int) (*PaymentsAccountUser, error) {
	return findBillingUserByIntID(ctx, r.store, userID, "user_id", "payments repository", mapBillingUserToPaymentsAccountUser)
}

func (r *PgPaymentsRepository) FindUserByEmail(ctx context.Context, email string) (*PaymentsAccountUser, error) {
...
func (r *PgPaymentsRepository) UpdateCustomerID(ctx context.Context, userID int, customerID string) error {
...
func (r *PgPaymentsRepository) UpdateSubscription(ctx context.Context, userID int, update SubscriptionUpdate) error {
	dbUserID, err := convert.Int32(userID, "user_id")
	if err != nil {
		return err
	}
...
func (r *PgAccountSettingsRepository) FindUserByID(ctx context.Context, userID int) (*PaymentsAccountUser, error) {
	return (&PgPaymentsRepository{store: r.store}).FindUserByID(ctx, userID)
}

func (r *PgAccountSettingsRepository) FindUserByEmail(ctx context.Context, email string) (*PaymentsAccountUser, error) {
	return (&PgPaymentsRepository{store: r.store}).FindUserByEmail(ctx, email)
}

func (r *PgAccountSettingsRepository) UpdateCustomerID(ctx context.Context, userID int, customerID string) error {
	return (&PgPaymentsRepository{store: r.store}).UpdateCustomerID(ctx, userID, customerID)
}

func (r *PgAccountSettingsRepository) UpdateSubscription(ctx context.Context, userID int, update SubscriptionUpdate) error {
	return (&PgPaymentsRepository{store: r.store}).UpdateSubscription(ctx, userID, update)
}
