export const migrationsJournal = {
  "version": "7",
  "dialect": "sqlite",
  "entries": [
    {
    ...
    },
    {
      ...
      "version": "6",
      "when": 1783040085831,
      "tag": "0001_youthful_miracleman",
      "breakpoints": true
    }
  ]
} as const;

const migration_0000_supreme_quicksilver_sql = `CREATE TABLE \`auth_sessions\` (
...
const migration_0001_youthful_miracleman_sql = `DROP INDEX \`conversations_conversation_id_idx\`;--> statement-breakpoint
DROP INDEX \`messages_message_id_idx\`;
`;

export const migrations = {
  "m0000": migration_0000_supreme_quicksilver_sql,
  "m0001": migration_0001_youthful_miracleman_sql,
};
