...
const config = {
  ...
  collectCoverageFrom: [
    ...
    '!<rootDir>/src/screens/**/*',
    '!<rootDir>/src/features/desktop-work/DesktopWorkScreen.tsx',
    ...
    '!<rootDir>/src/storage/database/sqlite-persister.ts',
    '!<rootDir>/src/storage/database/storage-adapter.ts',
    '!<rootDir>/src/storage/conversations/internal.ts',
    '!<rootDir>/src/storage/database/sqlite-adapter.internal.ts',
    '!<rootDir>/src/storage/database/encryption.ts',
    '!<rootDir>/src/storage/database/encryption-migration.ts',
    '!<rootDir>/src/storage/database/manager.ts',
    '!<rootDir>/src/storage/migrations/migration-runner.ts',
    '!<rootDir>/src/storage/migrations/schema-patches.ts',
