...
export const IOS_PINNED_SPKI_HASHES: readonly string[] = PINNED_CA_SPKI_HASHES;
...
export const PIN_MAX_AGE_SECONDS = 2_592_000; // 30 days
...
export const hasPlaceholderPins = (): boolean =>
