...
import { setBrowserClient } from '@taskforceai/contracts/browserClient';

// Mark the very beginning of the JS bundle execution
const STARTUP_TIME = Date.now();
const readDisableE2ESyncFlag = (): string | undefined => {
  try {
    return process.env.EXPO_PUBLIC_DISABLE_E2E_SYNC;
  } catch {
    return globalThis.process?.env?.EXPO_PUBLIC_DISABLE_E2E_SYNC;
  }
};
const isE2ESyncDisabled = readDisableE2ESyncFlag() === '1';
