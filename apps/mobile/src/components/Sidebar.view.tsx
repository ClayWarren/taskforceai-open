...
import { createSidebarHighlightParts, createSidebarSnippet } from '@taskforceai/shared';
    ...
    if (!isAuthenticated) {
      return (
        <View style={styles.emptyState}>
          <Text style={styles.emptyTitle}>{t('sidebar.notLoggedIn', 'Not logged in')}</Text>
          <Text style={styles.emptySubtitle}>{t('sidebar.pleaseLogIn', 'Please log in to view your conversations')}</Text>
        </View>
      );
    }
    return (
