import { PROMPT_OPTION_LABELS } from '@taskforceai/shared';
      ...
      <View style={styles.optionLeft}>
        <View
          style={[
            ...
            { backgroundColor: option.enabled ? 'rgba(59,130,246,0.2)' : 'rgba(255,255,255,0.05)' },
          ]}
        >
          <Icon
            ...
            >
              <Text
                style={[
                  ...
                  agentCount === count && { color: '#ffffff', fontWeight: 'bold' },
                ]}
              >
                {count}
              </Text>
