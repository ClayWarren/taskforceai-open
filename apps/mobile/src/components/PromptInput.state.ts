...
export function usePromptInputState({
  ...
  const [internalAutonomousModeEnabled, setInternalAutonomousModeEnabled] =
    useState(autonomousModeEnabledProp ?? false);
  ...
  const autonomousModeEnabled =
    autonomousModeEnabledProp ?? internalAutonomousModeEnabled;
