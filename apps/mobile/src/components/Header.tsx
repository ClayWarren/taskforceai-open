...
import { MobileTaskModeSwitcher, type MobileTaskMode } from './MobileTaskModeSwitcher';
...
interface HeaderProps {
  ...
  onTaskModeChange?: (_mode: MobileTaskMode) => void;
}
...
export function Header({
  ...
  return (
    ...
    >
      ...
      <MobileTaskModeSwitcher
        mode={taskMode}
        onModeChange={(mode) => onTaskModeChange?.(mode)}
      />
