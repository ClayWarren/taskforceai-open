...
describe('usePromptVoice', () => {
    ...
    it('starts not listening', async () => {
        const { result } = await renderHook(() => usePromptVoice(), { wrapper: createWrapper() });
    ...
    it('cancels voice on cleanup unmount', async () => {
        const { unmount } = await renderHook(() => usePromptVoice(), { wrapper: createWrapper() });
        await unmount();
    ...
    it('does not publish transcription after unmount', async () => {
        ...
        const { result, unmount } = await renderHook(() => usePromptVoice(), { wrapper: createWrapper() });
