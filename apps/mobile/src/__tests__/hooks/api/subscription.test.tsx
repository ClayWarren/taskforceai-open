...
describe('useSubscriptionQuery', () => {
  ...
  it('calls getSubscription', async () => {
    ...
    await renderHookWithQueryClient(() => useSubscriptionQuery());
  ...
  it('returns subscription data', async () => {
    ...
    const { result } = await renderHookWithQueryClient(() => useSubscriptionQuery());
  ...
  it('is disabled when enabled option is false', async () => {
    ...
    await renderHookWithQueryClient(() => useSubscriptionQuery({ enabled: false }));
  ...
  it('uses correct query key', async () => {
    mockClient.getSubscription.mockResolvedValueOnce({ status: 'free' });
    const { queryClient } = await renderHookWithQueryClient(() => useSubscriptionQuery());
...
describe('useProductsQuery', () => {
  ...
  it('calls getProducts', async () => {
    ...
    await renderHookWithQueryClient(() => useProductsQuery());
  ...
  it('returns products data', async () => {
    ...
    const { result } = await renderHookWithQueryClient(() => useProductsQuery());
  ...
  it('is disabled when enabled option is false', async () => {
    ...
    await renderHookWithQueryClient(() => useProductsQuery({ enabled: false }));
  ...
  it('uses correct query key', async () => {
    mockClient.getProducts.mockResolvedValueOnce([]);
    const { queryClient } = await renderHookWithQueryClient(() => useProductsQuery());
...
describe('useBillingBalanceQuery', () => {
  ...
  it('calls getBalance', async () => {
    ...
    await renderHookWithQueryClient(() => useBillingBalanceQuery());
  ...
  it('is disabled when enabled option is false', async () => {
    ...
    await renderHookWithQueryClient(() => useBillingBalanceQuery({ enabled: false }));
...
describe('useSyncMobileSubscriptionMutation', () => {
  ...
  it('calls syncMobileSubscription', async () => {
    const { result } = await renderHookWithQueryClient(() => useSyncMobileSubscriptionMutation());
  ...
  it('invalidates subscription and user queries on success', async () => {
    const { result, queryClient } = await renderHookWithQueryClient(() => useSyncMobileSubscriptionMutation());
