...
describe('useModelSelectorQuery', () => {
  ...
  it('calls getModelOptions', async () => {
    ...
    renderHookWithQueryClient(() => useModelSelectorQuery());
  ...
  it('does not call getModelOptions when disabled', async () => {
    renderHookWithQueryClient(() => useModelSelectorQuery({ enabled: false }));
  ...
  it('returns model options data', async () => {
    ...
    const { result } = renderHookWithQueryClient(() => useModelSelectorQuery());
  ...
  it('uses correct query key', async () => {
    ...
    const { queryClient } = renderHookWithQueryClient(() => useModelSelectorQuery());
