...
import { PromptInput, resolvePromptMaxWidth } from '../components/PromptInput';
...
describe('PromptInput', () => {
  ...
  it('keeps the prompt within narrow viewports', () => {
    expect(resolvePromptMaxWidth(320)).toBeLessThan(320);
    expect(resolvePromptMaxWidth(0)).toBe(0);
  });
});
