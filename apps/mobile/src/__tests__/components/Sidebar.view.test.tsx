...
describe('SidebarView', () => {
  ...
  it('renders the projects row, settings footer, and pagination footer', async () => {
    ...
    await fireEvent.press(getByLabelText('Open Projects'));
  ...
  it('hides project actions but keeps settings visible for guest users', async () => {
    ...
    expect(queryByLabelText('Open Projects')).toBeNull();
    await fireEvent.press(getByLabelText('Open settings'));
