...
describe('SidebarView', () => {
  it('renders unauthenticated empty state', () => {
    ...
    expect(getByText('Please log in to view your conversations')).toBeTruthy();
  });
  ...
  it('hides settings footer when user metadata is not available', () => {
    const props = createProps({
      isAuthenticated: true,
      userName: undefined,
      userInitials: undefined,
    ...
    const { queryByLabelText } = render(<SidebarView {...props} />);
