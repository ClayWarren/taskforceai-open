...
describe('Sidebar', () => {
  it('does not show cached local or remote conversations while signed out', async () => {
    mockConversationData = [
      {
        id: 7,
  ...
  it('shows a single Desktop sidebar row while authenticated', async () => {
    const onDesktopSessionsPress = jest.fn();
    const { getByLabelText, getByText } = renderSidebar({ onDesktopSessionsPress });
