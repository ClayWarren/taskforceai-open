...
import { RemoteReviewPanel } from '../../../components/remote/RemoteReviewPanel';
...
describe('Remote panels', () => {
  ...
  it('renders thread detail status and code tabs', async () => {
    ...
    await fireEvent.press(screen.getByLabelText('Remote changes'));
    await fireEvent.press(screen.getByLabelText('Remote files'));
