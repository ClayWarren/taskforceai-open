...
describe('ProjectsScreen', () => {
  ...
  it('creates a project with trimmed values', async () => {
    ...
    fireEvent.changeText(getByPlaceholderText('Description (optional)'), '  First project  ');
    fireEvent.changeText(getByPlaceholderText('Custom instructions (optional)'), '  Use concise updates.  ');
  ...
  it('clears active selection when deleting active project', async () => {
    ...
    fireEvent.press(getAllByText('icon-Trash2')[0]);
