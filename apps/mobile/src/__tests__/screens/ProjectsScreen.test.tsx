...
describe('ProjectsScreen', () => {
  ...
  it('renders empty state when there are no projects', async () => {
    ...
    expect(getByText('Start your first project')).toBeTruthy();
    expect(getByText('Projects help you organize chats, files, and tools in one place')).toBeTruthy();
  ...
  it('creates a project with trimmed values', async () => {
    ...
    await fireEvent.press(getByText('New project'));
