    ...
    <Modal visible={props.visible} transparent animationType="fade" onRequestClose={props.onClose}>
      <TouchableOpacity activeOpacity={1} onPress={props.onClose} style={styles.menuBackdrop}>
        ...
        >
          ...
          <MenuRow icon="Plus" label="Add project" onPress={props.onAddProject} />
          <MenuRow icon="Monitor" label="Switch Mac" onPress={props.onSwitchConnection} />
    ...
    <Modal visible={props.visible} transparent animationType="fade" onRequestClose={props.onClose}>
      <TouchableOpacity activeOpacity={1} onPress={props.onClose} style={styles.menuBackdrop}>
        ...
        >
          ...
          />
          {props.codeMode && props.onGit ? (
            <MenuRow
              icon="GitPullRequest"
              label="Git"
              accessibilityLabel="Open remote Git actions"
              onPress={props.onGit}
            />
          ) : null}
        </View>
