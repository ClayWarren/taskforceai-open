/** Declarative legacy schema rebuild owned by the migration package. */
...
export const SCHEMA_REBUILD_CONFIGS: SchemaRebuildConfig[] = [
  {
    ...
    // coverage-ignore-start -- declarative SQL template, executed by SQLite rather than JavaScript
    createSql: `
