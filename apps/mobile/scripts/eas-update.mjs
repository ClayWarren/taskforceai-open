...
const easCliPackagePath = require.resolve('eas-cli/package.json');
const easCliEntryPoint = join(dirname(easCliPackagePath), 'bin', 'run');
...
const commandArgs = [easCliEntryPoint, 'update', '--channel', channel, ...channelOption.args];
