...
await mock.module('../src/storage/conversations/internal', () => ({
...
const migrationRunner = await import('../src/storage/migrations/migration-runner');
const pendingPromptStorage = await import('../src/storage/conversations/pending-prompts');
