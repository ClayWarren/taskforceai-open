...
const mockExpoFileSystem = {
  ...
  Paths: {
    document: { uri: mockFileSystem.documentDirectory },
    cache: { uri: mockFileSystem.cacheDirectory },
  },
};
...
jest.mock('lucide-react-native', () => {
  ...
  const iconNames =
    'Activity ArrowUpRight AudioLines ChevronDown ChevronUp Clock Copy Check Settings LogOut Globe Sun Moon Monitor MessageSquare Plus Trash2 MoreVertical Send Mic StopCircle Info AlertTriangle RefreshCw ExternalLink Menu Sparkles Zap X'.split(
      ' '
    );
  return {
