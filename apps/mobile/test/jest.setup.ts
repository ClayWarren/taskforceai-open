...
jest.mock('lucide-react-native', () => {
  ...
  const iconNames =
    'Activity ArrowUpRight ChevronDown ChevronUp Clock Copy Check Settings LogOut Globe Sun Moon Monitor MessageSquare Plus Trash2 MoreVertical Send Mic StopCircle Info AlertTriangle RefreshCw ExternalLink Menu Sparkles Zap X'.split(
      ' '
    );
  return {
