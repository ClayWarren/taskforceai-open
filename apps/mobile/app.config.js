  ...
  return {
    ...
    plugins: [
      ...
      [
        ...
        {
          cameraPermission:
            'TaskForceAI uses the camera to take conversation photos and scan secure desktop pairing QR codes.',
      ...
      [
        'expo-widgets',
        {
          bundleIdentifier: 'com.taskforceai.mobile.widgets',
          groupIdentifier: 'group.com.taskforceai.mobile',
          ...
          widgets: [
            {
              ...
              description: 'Shows active Remote agents and work that needs attention.',
