...
// NewSandboxPoolFromEnv builds the engine's Daytona-backed sandbox pool.
func NewSandboxPoolFromEnv() *coretools.SandboxPool {
...
type daytonaSandboxRuntime interface {
	...
	UploadFile(ctx context.Context, content []byte, path string) error
	DeleteFile(ctx context.Context, path string, recursive bool) error
	MoveFiles(ctx context.Context, source, destination string) error
}
...
func (r daytonaSDKSandboxRuntime) DownloadFile(ctx context.Context, path string) ([]byte, error) {
	return r.sandbox.FileSystem.DownloadFile(ctx, path, nil)
}

func (r daytonaSDKSandboxRuntime) UploadFile(ctx context.Context, content []byte, path string) error {
	return r.sandbox.FileSystem.UploadFile(ctx, content, path)
}

func (r daytonaSDKSandboxRuntime) DeleteFile(ctx context.Context, path string, recursive bool) error {
	return r.sandbox.FileSystem.DeleteFile(ctx, path, recursive)
}

func (r daytonaSDKSandboxRuntime) MoveFiles(ctx context.Context, source, destination string) error {
	return r.sandbox.FileSystem.MoveFiles(ctx, source, destination)
}
...
func (s *daytonaSandbox) ReadFile(ctx context.Context, path string) ([]byte, error) {
	return s.runtime.DownloadFile(ctx, path)
}

func (s *daytonaSandbox) WriteFile(ctx context.Context, path string, content []byte) error {
	return s.runtime.UploadFile(ctx, content, path)
}

func (s *daytonaSandbox) DeleteFile(ctx context.Context, path string) error {
	return s.runtime.DeleteFile(ctx, path, false)
}

func (s *daytonaSandbox) MoveFile(ctx context.Context, oldPath, newPath string) error {
	return s.runtime.MoveFiles(ctx, oldPath, newPath)
}
