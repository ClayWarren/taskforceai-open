...
func TestHandleTaskSubmissionIdempotencyExistingTask(t *testing.T) {
	...
	result, reserved := handleTaskSubmissionIdempotency(context.Background(), 7, "key", "task-new", registry)
...
func TestHandleTaskSubmissionIdempotencyRecoverReserveErrorContinues(t *testing.T) {
	...
	result, stillReserved := handleTaskSubmissionIdempotency(ctx, 7, "recover-fail", "task-new", &captureRegistry{})
	assert.Nil(t, result)
...
func TestHandleTaskSubmissionIdempotencyRecoveredExistingTask(t *testing.T) {
	...
	result, stillReserved := handleTaskSubmissionIdempotency(ctx, 7, "stale-recovered-existing", "task-new", registry)
...
func TestHandleTaskSubmissionIdempotencyRecoveredTaskStillRegistered(t *testing.T) {
	...
	result, stillReserved := handleTaskSubmissionIdempotency(ctx, 7, "stale-recovered", "task-new", registry)
	require.NotNil(t, result)
	assert.Equal(t, "task-recovered", result.TaskID)
	assert.False(t, stillReserved)
}

func TestHandleTaskSubmissionIdempotencyReserveErrorContinues(t *testing.T) {
	withUnavailableRedis(t, errors.New("redis offline"))

	result, reserved := handleTaskSubmissionIdempotency(context.Background(), 7, "key", "task-new", &captureRegistry{})
	assert.Nil(t, result)
...
func TestHandleTaskSubmissionIdempotencyReturnsExistingRegisteredTask(t *testing.T) {
	...
	result, reserved := handleTaskSubmissionIdempotency(ctx, 7, "existing-key", "task-new", registry)
	require.NotNil(t, result)
...
func TestHandleTaskSubmissionIdempotencyReturnsExistingCompletedStatus(t *testing.T) {
	...
	result, reserved := handleTaskSubmissionIdempotency(ctx, 7, "done-key", "task-new", registry)
	require.NotNil(t, result)
...
func TestHandleTaskSubmissionIdempotencyReturnsExistingTask(t *testing.T) {
	...
	result, stillReserved := handleTaskSubmissionIdempotency(context.Background(), 7, "idem-key", "task-new", registry)
	require.NotNil(t, result)
	assert.Equal(t, "task-existing", result.TaskID)
	assert.False(t, stillReserved)
}

func TestHandleTaskSubmissionIdempotencyStaleReleaseDelFailureContinues(t *testing.T) {
	...
	result, stillReserved := handleTaskSubmissionIdempotency(ctx, 7, "stale-release-fail", "task-new", &captureRegistry{})
	assert.Nil(t, result)
	assert.False(t, stillReserved)
}
...
func TestHandleTaskSubmissionIdempotencyStaleReleaseFailureContinues(t *testing.T) {
	...
	registry := &captureRegistry{tasks: map[string]*TaskState{}}
	result, stillReserved := handleTaskSubmissionIdempotency(ctx, 7, "stale-release", "task-new", registry)
	assert.Nil(t, result)
...
func TestHandleTaskSubmissionIdempotencyStillPointsToStaleTask(t *testing.T) {
	...
	registry := &captureRegistry{tasks: map[string]*TaskState{}}
	result, stillReserved := handleTaskSubmissionIdempotency(ctx, 7, "stale-still", "task-new", registry)
	assert.Nil(t, result)
	assert.False(t, stillReserved)
...
func TestHandleTaskSubmissionIdempotencyKeepsFreshPendingReservation(t *testing.T) {
	...
	result, stillReserved := handleTaskSubmissionIdempotency(ctx, 7, "pending", "task-second", &captureRegistry{})
	require.NotNil(t, result)
...
func TestHandleTaskSubmissionIdempotency_ReturnsExistingRegisteredTaskDirect(t *testing.T) {
	...
	result, stillReserved := handleTaskSubmissionIdempotency(context.Background(), 9, "dedupe-key", "task-new", registry)
	require.NotNil(t, result)
