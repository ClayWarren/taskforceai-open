...
func getSharedSandboxPool() *coretools.SandboxPool {
	...
	if sharedSandboxPool == nil {
		sharedSandboxPool = newDaytonaSandboxPoolFromEnv()
	}
...
func initOrchestrator(input OrchestratorInitInput) *orchestrator.TaskOrchestrator {
	...
	installEnginecoreToolRuntime()
	installEnginecoreInstructionContextSource()
	installEnginecoreWebFetchSource()
	installEnginecoreArchiveWriter()
	installEnginecoreChartWriter()
	installEnginecoreCSVWriter()
	installEnginecoreDocumentWriter()
	installEnginecorePDFWriter()
	installEnginecorePresentationWriter()
	installEnginecoreSpreadsheetWriter()
	installEnginecoreSiteWriter()
