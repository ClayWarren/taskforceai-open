...
type RunRequest struct {
	...
	ModelID       string     `json:"modelId" minLength:"1" doc:"Model identifier"`
	Stream        bool       `json:"stream" doc:"Whether to stream response"`
...
type ThreadRunRequest struct {
	...
	ModelID string `json:"modelId" minLength:"1" doc:"Model identifier"`
	Stream  bool   `json:"stream" doc:"Whether to stream"`
}
...
func RegisterHandlers(api huma.API, q DeveloperQueries, convService conversations.Service, inngest run.InngestSender) {
	...
	huma.Register(api, huma.Operation{
		OperationID: "developer-run-task",
		Method:      http.MethodPost,
		Path:        "/api/v1/developer/run",
		Summary:     "Run a developer task",
	...
	// Task Status
	huma.Register(api, huma.Operation{
		OperationID: "developer-get-task-status",
	...
	// Task Results
	huma.Register(api, huma.Operation{
		OperationID: "developer-get-task-results",
		Method:      http.MethodGet,
		Path:        "/api/v1/developer/results/{id}",
	...
	// Threads
	huma.Register(api, huma.Operation{
		OperationID: "developer-list-threads",
		Method:      http.MethodGet,
		Path:        "/api/v1/developer/threads",
		Summary:     "List developer threads",
		Tags:        []string{"Developer"},
		Security:    []map[string][]string{{"api_key": {}}},
	}, h.ListThreads)

	huma.Register(api, huma.Operation{
		OperationID: "developer-create-thread",
		Method:      http.MethodPost,
		Path:        "/api/v1/developer/threads",
	...
	huma.Register(api, huma.Operation{
		OperationID: "developer-get-thread",
		Method:      http.MethodGet,
		Path:        "/api/v1/developer/threads/{id}",
		Summary:     "Get a developer thread",
		Tags:        []string{"Developer"},
		Security:    []map[string][]string{{"api_key": {}}},
	}, h.GetThread)
	...
	huma.Register(api, huma.Operation{
		OperationID: "developer-get-thread-messages",
		Method:      http.MethodGet,
		Path:        "/api/v1/developer/threads/{id}/messages",
	...
	// Thread Runs
	huma.Register(api, huma.Operation{
		OperationID: "developer-run-thread",
		Method:      http.MethodPost,
		Path:        "/api/v1/developer/threads/{id}/runs",
		Summary:     "Run a task on a thread",
		Tags:        []string{"Developer"},
		Security:    []map[string][]string{{"api_key": {}}},
	}, h.RunThread)
}
...
func (h *developerHandlers) RunTask(ctx context.Context, input *struct {
	...
	if rateLimitErr := runhandlers.EnforceRunRateLimit(ctx, input.User.Email, input.User.ID, input.OrgID); rateLimitErr != nil {
