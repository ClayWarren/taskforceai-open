...
import (
	...
	adapterrequestmeta "github.com/TaskForceAI/adapters/pkg/requestmeta"
...
var ClientIPFromRemoteAddr = adapterrequestmeta.ClientIPFromRemoteAddr
...
func isPIIMetadataKey(key string) bool {
	switch key {
	case "email", "email_address", "actor_email", "target_email", "fullName", "full_name", "password", "token", "accessToken", "id_token":
		return true
	}
