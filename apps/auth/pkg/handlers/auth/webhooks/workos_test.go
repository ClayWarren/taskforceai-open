...
func TestWorkOSWebhook_UserDeleted(t *testing.T) {
	called := false
	mockVal := new(webhookValidatorMock)
	mockVal.On("ValidatePayload", mock.Anything, mock.Anything).Return(`{"id":"1","event":"dsync.user.deleted","data":{"organization_id":"org","email":"a@b.com"}}`, nil)
...
func TestWorkOSWebhook_UserDeactivatedEvent(t *testing.T) {
	called := false
	mockVal := new(webhookValidatorMock)
	mockVal.On("ValidatePayload", mock.Anything, mock.Anything).Return(`{"id":"1","event":"dsync.user.deactivated","data":{"organization_id":"org","email":"a@b.com"}}`, nil)
...
func TestWorkOSWebhook_GroupUserAdded(t *testing.T) {
	called := false
	mockVal := new(webhookValidatorMock)
	mockVal.On("ValidatePayload", mock.Anything, mock.Anything).Return(`{"id":"1","event":"dsync.group.user_added","data":{"user":{"organization_id":"org","email":"a@b.com"}}}`, nil)
...
func TestWorkOSWebhook_AddMembershipError(t *testing.T) {
	mockVal := new(webhookValidatorMock)
	mockVal.On("ValidatePayload", mock.Anything, mock.Anything).Return(`{"id":"1","event":"dsync.user.created","data":{"organization_id":"org","email":"a@b.com"}}`, nil)
...
func TestWorkOSWebhook_RemoveMembershipError(t *testing.T) {
	mockVal := new(webhookValidatorMock)
	mockVal.On("ValidatePayload", mock.Anything, mock.Anything).Return(`{"id":"1","event":"dsync.group.user_removed","data":{"user":{"organization_id":"org","email":"a@b.com"}}}`, nil)
