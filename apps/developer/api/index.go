...
var (
	...
	developerReadLimit  = devhandler.WithOrgRateLimitScope("developer_read", 120, time.Hour)
	developerWriteLimit = devhandler.WithOrgRateLimitScope("developer_write", 20, 24*time.Hour)
