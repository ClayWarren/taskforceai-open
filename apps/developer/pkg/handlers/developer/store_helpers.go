...
func loadDeveloperAccount(ctx context.Context, store developerAccountStore, userID int) (*developerAccount, error) {
	return store.GetDeveloperAccount(ctx, userID)
}
