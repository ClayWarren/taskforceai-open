...
func RegisterUsageHandler(api huma.API, q querySource) {
	huma.Register(api, huma.Operation{
		...
		usageUser := developer.UsageUser{
			ID:                    user.ID,
			APIRequestsUsed:       account.APIRequestsUsed,
			APIRequestsLimit:      account.APIRequestsLimit,
			APICurrentPeriodStart: account.APICurrentPeriodStart,
			APICurrentPeriodEnd:   account.APICurrentPeriodEnd,
		}
