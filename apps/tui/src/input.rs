...
pub fn map_key_event_with_keyboard_enhancement(
    ...
    match key.code {
        ...
        KeyCode::Left => Some(InputAction::SelectPreviousEffort),
        KeyCode::Right => Some(InputAction::SelectNextEffort),
...
mod tests {
    ...
    fn maps_selection_keys() {
        ...
        assert_eq!(
            ...
            Some(InputAction::SelectPreviousEffort)
        );
        assert_eq!(
            map_key_event(press(KeyCode::Right, KeyModifiers::NONE)),
            Some(InputAction::SelectNextEffort)
        );
    }
