...
impl ApiClient {
    ...
    pub async fn sync_realtime_poll(
        ...
        decode_json_response(response, "sync realtime poll").await
    }
    ...
    pub async fn list_projects(&self, token: &str) -> Result<Vec<ApiProject>, ApiClientError> {
        ...
        decode_json_response(response, "project list").await
    }
    ...
    pub async fn list_artifacts(
        ...
        decode_json_response(response, "artifact list").await
    }
    ...
    pub async fn get_artifact(
        ...
        decode_json_response(response, "artifact detail").await
    }
    ...
    pub async fn list_artifact_versions(
        ...
        decode_json_response(response, "artifact versions").await
    }
