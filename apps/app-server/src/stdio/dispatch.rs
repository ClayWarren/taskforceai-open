...
pub(super) async fn dispatch(
    ...
    let result = match request {
        ...
        | AppRequest::McpAuthClear(_)) => dispatch_connected_request(request, runtime).await,
...
async fn dispatch_interactive_request(
    ...
    match request {
        ...
        _ => unreachable!("interactive request group must be routed by dispatch"),
    }
}
...
async fn dispatch_connected_request(
    ...
    match request {
        ...
        _ => unreachable!("connected request group must be routed by dispatch"),
    }
}
