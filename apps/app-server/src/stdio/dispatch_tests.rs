...
async fn dispatch_covers_direct_request_variants() {
    ...
    for request in [
        ...
        AppRequest::ThreadList(ThreadListParams::default()),
        AppRequest::ThreadTurnsList(ThreadTurnsListParams {
            thread_id: "missing-thread".to_string(),
            cursor: None,
            limit: None,
            include_items: None,
        }),
        AppRequest::ThreadItemsList(ThreadItemsListParams {
            thread_id: "missing-thread".to_string(),
            turn_id: None,
            cursor: None,
            limit: None,
        ...
        AppRequest::RemoteSettingsGet,
        AppRequest::RemoteSettingsUpdate(RemoteSettingsUpdateParams {
            allow_connections: Some(false),
            keep_awake: Some(false),
        }),
        AppRequest::RemotePairingCodeCreate,
        AppRequest::RemoteControllerList,
        AppRequest::RemoteControllerRevoke(RemoteControllerRevokeParams {
        ...
        AppRequest::ProjectWorkspaceSet(ProjectWorkspaceSetParams {
            project_id: 1,
            workspace_roots: vec![git_workspace.clone()],
        }),
        ...
        AppRequest::McpServerStatusList(McpServerStatusListParams::default()),
        ...
        AppRequest::McpOAuthStart(McpOAuthStartParams {
            name: "missing".into(),
            redirect_uri: String::new(),
            scopes: Vec::new(),
        }),
        AppRequest::McpOAuthComplete(McpOAuthCompleteParams {
            name: "missing".into(),
            callback_url: String::new(),
        }),
        AppRequest::McpOAuthStatus(McpServerParams {
            name: "missing".into(),
        }),
        AppRequest::ApiRequest(ApiRequestParams {
