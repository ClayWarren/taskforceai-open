...
function OverviewPage() {
  ...
  const { stats } = useDeveloperUsageStats({ isAuthenticated, isAuthLoading, userScope });
          ...
          <div className="mt-8 flex items-center gap-12">
            <div className="relative h-32 w-32 shrink-0">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-2xl font-bold text-white">{requestsLabel}</span>
            ...
            <div className="grid flex-1 grid-cols-3 gap-4">
              <div>
                ...
                <p className="mt-1 text-sm font-bold text-white">{totalRequestsLabel}</p>
              ...
              <div>
                ...
                <p className="mt-1 text-sm font-bold text-white">{activeApiKeyCount}</p>
                <p className="text-[10px] text-slate-400">Same plan limits</p>
              </div>
              <div>
                <p className="text-[10px] font-bold tracking-widest text-slate-400 uppercase">
                  Daily Avg
