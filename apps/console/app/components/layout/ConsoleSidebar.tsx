  ...
  return (
    <>
      ...
      <aside
        ...
        className={cn(
          'fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-white/10 bg-black transition-[transform,visibility] lg:visible lg:pointer-events-auto lg:translate-x-0',
