...
import { storageNotFoundError } from '@taskforceai/persistence';
...
const createStorage = (): SyncStorage => ({
  ...
  getConversation: async () => ({ ok: false, error: storageNotFoundError('missing') }),
  upsertConversation: async () => {},
  deleteConversation: async () => {},
  replaceConversationId: async () => {},
  getMessages: async () => [],
  getMessage: async () => ({ ok: false, error: storageNotFoundError('missing') }),
  upsertMessage: async () => {},
  deleteMessage: async () => {},
