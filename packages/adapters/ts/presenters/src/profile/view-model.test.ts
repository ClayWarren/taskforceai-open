...
describe('profile view model helpers', () => {
  ...
  it('normalizes plan and usage labels', () => {
    ...
    expect(resolveProfilePlanThroughputLabel('pro')).toBe('2 messages per hour');
  ...
  it('builds free and paid usage limit view models', () => {
    expect(
      ...
      description: '1 message per week',
    ...
    expect(
      ...
      description: '2 messages per hour',
      usedLabel: '42 messages used',
