...
export interface ConversationStore {
  ...
  setConversationProjectId?(conversationId: string, projectId: number | null): Promise<void>;
  ...
  truncateConversation?(conversationId: string, fromMessageId: string): Promise<void>;
