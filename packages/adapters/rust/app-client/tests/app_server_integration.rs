...
async fn client_spawns_app_server_and_receives_run_event() {
    ...
    let mut client = AppServerClient::spawn_with_options(
        ...
        AppServerSpawnOptions {
            ...
            keychain_service: Some("com.taskforceai.app-client.integration-test".to_string()),
    ...
    client
        .auth_logout()
        .await
        .expect("integration auth credential should be removed");
