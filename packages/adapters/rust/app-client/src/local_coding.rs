...
mod tests {
    ...
    use super::{
        enable_workspace_tools, enable_workspace_tools_with_handle, filesystem_mcp_endpoint,
        filesystem_tool_names, is_broad_workspace_root, quote_command_arg, validate_workspace_path,
