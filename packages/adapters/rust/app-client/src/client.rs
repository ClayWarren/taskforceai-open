...
use taskforceai_app_protocol::{
    AckResult, ActiveProjectResult, AgentSessionCreateParams, AgentSessionIDParams,
    AgentSessionListResult, AgentSessionMessageParams, AgentSessionResult, AgentSessionRunParams,
    AgentSessionRunResult, ApiHealthResult, ApiRequestParams, ApiRequestResult, AppServerEvent,
    AttachmentAddParams, AttachmentAddResult, AttachmentListResult, AuthStatus,
    BrowserStatusResult, ChannelAddParams, ChannelIDParams, ChannelListResult, ChannelPushParams,
    ChannelResult, ClientCapabilities, ClientInfo, CommandExecuteParams, CommandExecuteResult,
    ComputerUseStatusResult, ConfigBatchWriteParams, ConfigReadParams, ConfigReadResult,
    ConfigWriteParams, ContextSummaryResult, ConversationIDParams, ConversationListParams,
    ConversationListResult, ConversationRecord, ConversationReplaceIDParams, ConversationResult,
    DesktopSyncPullParams, DesktopSyncPullResult, DesktopSyncPushParams, DesktopSyncPushResult,
    DeviceLoginPollParams, DeviceLoginPollResult, DeviceLoginStartResult, DiagnosticsInspectResult,
    FsUnwatchParams, FsWatchParams, FsWatchResult, GitBranchCheckoutParams, GitBranchCreateParams,
    GitBranchListParams, GitBranchListResult, GitPullRequestCreateParams,
    GitRepositoryActionParams, GitRepositoryCommitParams, GitReviewActionResult,
    ...
    HistoryListResult, HookListResult, HookRemoveParams, HookSetParams, HybridModeResult,
    HybridModeSetParams, InitializeParams, InitializeResult, JsonRpcError, JsonRpcResponse,
    LocalSettingsResult, LocalSettingsUpdateParams, McpAuthSetParams, McpAvailableResult,
    McpInspectResult, McpReloadResult, McpResourceReadParams, McpResourceReadResult,
    McpServerAddParams, McpServerListResult, McpServerParams, McpServerResult,
    ...
    PluginListResult, PluginSetEnabledParams, ProcessIDParams, ProcessListResult,
    ProcessReadParams, ProcessReadResult, ProcessResizeParams, ProcessResult, ProcessStartParams,
    ProcessWriteParams, ProjectCreateParams, ProjectIDParams, ProjectListResult, ProjectResult,
    ProjectWorkspaceResult, ProjectWorkspaceSetParams, PromptQueueDispatchAfterResponseParams,
    PromptQueueDispatchResult, PromptQueueIDParams, PromptQueueListResult, PromptQueueRecord,
    PromptQueueResult, QuickModeResult, QuickModeSetParams, RemoteControllerListResult,
    RemoteControllerRevokeParams, RemotePairingCodeResult, RemoteSettingsCommandParams,
    RemoteSettingsResult, RemoteSettingsUpdateParams, RunIDParams, RunModeSetParams,
    RunSearchParams, RunSearchResult, RunStatusResult, ScheduleAddParams, ScheduleIDParams,
    ScheduleListResult, ScheduleResult, ScheduleTickParams, ScheduleTickResult, SkillListResult,
    SkillRootsSetParams, SkillSetEnabledParams, SkillWatchParams, SkillWatchResult,
    StatusSummaryResult, SubmitRunParams, SubmitRunResult, SyncConfigureParams, SyncDeviceResult,
    SyncPullParams, SyncPullResult, SyncPushParams, SyncPushResult, SyncRealtimePollParams,
    SyncRealtimePollResult, SyncStatusResult, ThreadChildrenResult, ThreadCompactParams,
    ThreadCompactResult, ThreadIDParams, ThreadImportParams, ThreadListParams, ThreadListResult,
    ThreadMetadataUpdateParams, ThreadNameSetParams, ThreadResult, ThreadRollbackParams,
    ThreadSettingsParams, ThreadSettingsResult, ThreadSettingsUpdateParams, ThreadStartParams,
    ThreadStatusListResult, ThreadUsageResult, TurnDiffParams, TurnDiffResult, TurnInterruptParams,
    ...
    WorkflowRunResult, WorkflowSaveParams, WorkspaceFileListParams, WorkspaceFileListResult,
    WorkspaceFileReadParams, WorkspaceFileReadResult, JSONRPC_VERSION,
};
...
macro_rules! app_server_methods {
    () => {
        client_method!(config_read, "config/read", ConfigReadParams => ConfigReadResult);
        client_method!(config_write, "config/value/write", ConfigWriteParams => ConfigReadResult);
        client_method!(config_batch_write, "config/batch/write", ConfigBatchWriteParams => ConfigReadResult);
        client_method!(config_reload, "config/reload", ConfigReadResult);
        ...
        client_method!(remote_settings_get, "remote.settings.get", RemoteSettingsResult);
        client_method!(remote_settings_update, "remote.settings.update", RemoteSettingsUpdateParams => RemoteSettingsResult);
        client_method!(remote_pairing_code_create, "remote.pairingCode.create", RemotePairingCodeResult);
        client_method!(remote_controller_list, "remote.controller.list", RemoteControllerListResult);
        client_method!(remote_controller_revoke, "remote.controller.revoke", RemoteControllerRevokeParams => Value);
        ...
        client_method!(api_request, "api.request", ApiRequestParams => ApiRequestResult);
        client_method!(
            auth_device_start,
            "auth.deviceStart",
        ...
        client_method!(project_workspace_set, "project.workspace.set", ProjectWorkspaceSetParams => ProjectWorkspaceResult);
        ...
        client_method!(git_review_stage, "git.review.stage", GitReviewStageParams => GitReviewStatusResult);
        client_method!(git_review_comment_list, "git.review.comment.list", GitReviewCommentListParams => GitReviewCommentListResult);
        client_method!(git_review_comment_add, "git.review.comment.add", GitReviewCommentAddParams => GitReviewCommentResult);
        client_method!(git_review_comment_resolve, "git.review.comment.resolve", GitReviewCommentResolveParams => GitReviewCommentResult);
        client_method!(git_review_pull_request_action, "git.review.pullRequest.action", GitReviewPullRequestActionParams => GitReviewActionResult);
        client_method!(workspace_file_list, "workspace.file.list", WorkspaceFileListParams => WorkspaceFileListResult);
        client_method!(workspace_file_read, "workspace.file.read", WorkspaceFileReadParams => WorkspaceFileReadResult);
        client_method!(fs_watch, "fs/watch", FsWatchParams => FsWatchResult);
        client_method!(fs_unwatch, "fs/unwatch", FsUnwatchParams => AckResult);
        client_method!(git_branch_list, "git.branch.list", GitBranchListParams => GitBranchListResult);
        client_method!(git_branch_checkout, "git.branch.checkout", GitBranchCheckoutParams => GitReviewActionResult);
        client_method!(git_branch_create, "git.branch.create", GitBranchCreateParams => GitReviewActionResult);
        client_method!(git_repository_commit, "git.repository.commit", GitRepositoryCommitParams => GitReviewActionResult);
        client_method!(git_repository_pull, "git.repository.pull", GitRepositoryActionParams => GitReviewActionResult);
        client_method!(git_repository_push, "git.repository.push", GitRepositoryActionParams => GitReviewActionResult);
        client_method!(git_pull_request_create, "git.pullRequest.create", GitPullRequestCreateParams => GitReviewActionResult);
        client_method!(process_list, "process.list", ProcessListResult);
        client_method!(process_start, "process.start", ProcessStartParams => ProcessResult);
        client_method!(process_read, "process.read", ProcessReadParams => ProcessReadResult);
        client_method!(process_write, "process.write", ProcessWriteParams => ProcessResult);
        client_method!(process_resize, "process.resize", ProcessResizeParams => ProcessResult);
        client_method!(process_kill, "process.kill", ProcessIDParams => ProcessResult);
        client_method!(
            agent_session_list,
            "agentSession.list",
        ...
        client_method!(thread_list_filtered, "thread/list", ThreadListParams => ThreadListResult);
        client_method!(thread_children, "thread/children", ThreadIDParams => ThreadChildrenResult);
        client_method!(thread_status_list, "thread/status/list", ThreadStatusListResult);
        ...
        client_method!(thread_cancel, "thread/cancel", ThreadIDParams => ThreadResult);
        client_method!(thread_fork, "thread/fork", ThreadIDParams => ThreadResult);
        client_method!(thread_read, "thread/read", ThreadIDParams => ThreadResult);
        client_method!(thread_import, "thread/import", ThreadImportParams => ThreadResult);
        client_method!(thread_unarchive, "thread/unarchive", ThreadIDParams => ThreadResult);
        client_method!(thread_delete, "thread/delete", ThreadIDParams => Value);
        client_method!(thread_name_set, "thread/name/set", ThreadNameSetParams => ThreadResult);
        client_method!(thread_metadata_update, "thread/metadata/update", ThreadMetadataUpdateParams => ThreadResult);
        client_method!(thread_settings_get, "thread/settings/get", ThreadSettingsParams => ThreadSettingsResult);
        client_method!(thread_settings_update, "thread/settings/update", ThreadSettingsUpdateParams => ThreadSettingsResult);
        client_method!(thread_usage, "thread/tokenUsage", ThreadSettingsParams => ThreadUsageResult);
        client_method!(turn_diff, "turn/diff", TurnDiffParams => TurnDiffResult);
        client_method!(thread_rollback, "thread/rollback", ThreadRollbackParams => ThreadResult);
        client_method!(thread_compact, "thread/compact/start", ThreadCompactParams => ThreadCompactResult);
        ...
        client_method!(skill_set_enabled, "skill/setEnabled", SkillSetEnabledParams => SkillListResult);
        client_method!(skill_roots_set, "skill/roots/set", SkillRootsSetParams => SkillListResult);
        client_method!(skill_watch, "skill/watch", SkillWatchParams => SkillWatchResult);
        ...
        client_method!(hook_list, "hooks/list", HookListResult);
        client_method!(hook_set, "hooks/set", HookSetParams => HookListResult);
        client_method!(hook_remove, "hooks/remove", HookRemoveParams => HookListResult);
        client_method!(
            computer_use_status,
            "computerUse.status",
        ...
        client_method!(mcp_resource_read, "mcp/resource/read", McpResourceReadParams => McpResourceReadResult);
        client_method!(mcp_reload, "mcp/reload", McpReloadResult);
        client_method!(mcp_auth_set, "mcp/auth/set", McpAuthSetParams => McpInspectResult);
        client_method!(mcp_auth_clear, "mcp/auth/clear", McpServerParams => McpInspectResult);
    };
}
...
impl AppServerClient {
    ...
    pub async fn respond_server_request<P>(
        &self,
        request_id: Value,
        result: P,
    ...
    pub async fn initialize(&self) -> Result<InitializeResult, AppClientError> {
        self.request_handle().initialize().await
    }
    ...
    pub async fn shutdown(mut self) -> Result<(), AppClientError> {
        ...
        if let AppServerTransport::Stdio { child, stdin, .. } = &mut self.transport {
            stdin
                .lock()
                .await
                .shutdown()
...
impl AppServerRequestHandle {
    ...
    pub async fn initialize(&self) -> Result<InitializeResult, AppClientError> {
        ...
        let result = self
            .request::<InitializeResult, _>(
                "initialize",
                InitializeParams {
                    client_info: Some(ClientInfo {
                        name: "taskforceai_app_client".to_string(),
                        title: "TaskForceAI App Client".to_string(),
    ...
    async fn notify<P>(&self, method: &str, params: &P) -> Result<(), AppClientError>
    where
        P: Serialize,
    {
        match &self.transport {
            AppServerRequestTransport::Stdio { stdin, .. } => {
            ...
            AppServerRequestTransport::Http {
                ...
                client
                    ...
                    .json(&JsonRpcNotificationMessage {
                        jsonrpc: JSONRPC_VERSION,
                        method,
                        params,
                    })
    ...
    where
        P: Serialize,
    {
        let message = JsonRpcClientResponseMessage {
            jsonrpc: JSONRPC_VERSION,
            id: request_id,
            result,
        };
...
#[derive(Serialize)]
struct JsonRpcNotificationMessage<'a, P> {
    jsonrpc: &'static str,
    method: &'a str,
    params: P,
}
...
#[derive(Serialize)]
struct JsonRpcClientResponseMessage<P> {
    jsonrpc: &'static str,
    id: Value,
    result: P,
}
