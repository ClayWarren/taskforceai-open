...
use taskforceai_app_protocol::{
    ...
    ScheduleTickResult, SkillListResult, SkillRootsSetParams, SkillSetEnabledParams,
    SkillWatchParams, SkillWatchResult, StatusSummaryResult, SubmitRunParams, SubmitRunResult,
    ...
    ThreadIDParams, ThreadImportParams, ThreadListResult, ThreadMetadataUpdateParams,
    ThreadNameSetParams, ThreadResult, ThreadRollbackParams, ThreadStartParams,
    TurnInterruptParams, TurnResult, TurnStartParams, TurnSteerParams, UsageSummaryResult,
    VoiceRealtimeSetupParams, VoiceRealtimeSetupResult, VoiceSpeechGenerateParams,
    VoiceSpeechGenerateResult, VoiceTranscribeParams, VoiceTranscribeResult, WorkflowIDParams,
    WorkflowListResult, WorkflowResult, WorkflowRunIDParams, WorkflowRunListResult,
    WorkflowRunParams, WorkflowRunResult, WorkflowSaveParams, WorkspaceFileListParams,
    WorkspaceFileListResult, WorkspaceFileReadParams, WorkspaceFileReadResult, JSONRPC_VERSION,
};
...
impl AppServerClient {
    ...
    pub async fn initialize(&self) -> Result<InitializeResult, AppClientError> {
        ...
        let result = self
            ...
            .await?;
        self.request_handle().notify("initialized", &()).await?;
...
impl AppServerRequestHandle {
    ...
    pub async fn initialize(&self) -> Result<InitializeResult, AppClientError> {
        self.request("initialize", InitializeParams::default())
            .await
    }
