...
export type AppServerApiRequestParams = Generated.ApiRequestParams;
export type AppServerApiRequestResult = Generated.ApiRequestResult;
export type AppServerProjectCreateParams = Generated.ProjectCreateParams;
export type AppServerProjectResult = Generated.ProjectResult;
export type AppServerProjectWorkspaceSetParams = Generated.ProjectWorkspaceSetParams;
export type AppServerProjectWorkspaceResult = Generated.ProjectWorkspaceResult;
...
export type AppServerRemoteSettings = Generated.RemoteSettingsResult;
export type AppServerRemoteSettingsUpdate = Generated.RemoteSettingsUpdateParams;
export type AppServerRemotePairingCode = Generated.RemotePairingCodeResult;
export type AppServerRemoteController = Generated.RemoteControllerRecord;
export type AppServerRemoteControllerList = Generated.RemoteControllerListResult;
...
export type DesktopWorktree = Generated.DesktopGitWorktree;
export type DesktopWorktreeListResult = Generated.DesktopGitWorktreeListResult;
export type DesktopWorktreeCreateResult = Generated.DesktopGitWorktreeCreateResult;
export type DesktopWorktreeResetParams = Generated.DesktopWorktreeResetParams;
export type DesktopWorktreeRemoveParams = Generated.DesktopWorktreeRemoveParams;
export type DesktopWorktreeActionResult = Generated.DesktopGitWorktreeActionResult;
export type DesktopWorkspaceCheckpointCaptureParams = {
  root?: string | null;
  conversationId: string;
};
export type DesktopWorkspaceCheckpointRestoreParams = {
  conversationId: string;
  beforeTimestamp: number;
};
export type DesktopWorkspaceCheckpointResult = {
  supported: boolean;
  conversationId: string;
  capturedAt: number;
  workspace: string;
