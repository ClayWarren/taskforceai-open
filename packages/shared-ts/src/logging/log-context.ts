...
/** Clears request-scoped log context between tests; no-op outside Bun/Node test runs. */
/* coverage-ignore-start -- covered by log-context tests; Bun LCOV misses this env-gated branch. */
 ...
 */
/* coverage-ignore-start -- exercised in log-context tests; Bun LCOV misattributes AsyncLocalStorage calls. */
export function appendLogMetadata(meta: Record<string, unknown>): void {
 ...
 */
/* coverage-ignore-start -- exercised in log-context tests; Bun LCOV reports these lines as uncovered. */
