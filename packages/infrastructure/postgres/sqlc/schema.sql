...
-- Immutable content captured whenever a conversation is made public.
CREATE TABLE "public_conversation_snapshots" (
    "conversation_id" INTEGER NOT NULL,
    "title" TEXT NOT NULL,
    "messages" JSONB NOT NULL DEFAULT '[]'::JSONB,
    "snapshot_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "public_conversation_snapshots_pkey" PRIMARY KEY ("conversation_id")
);
...
CREATE TABLE "remote_targets" (
    ...
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "remote_targets_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "remote_connections" (
    ...
    "revoked_at" TIMESTAMP(3),
    CONSTRAINT "remote_connections_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "remote_targets_user_id_device_id_key" ON "remote_targets" ("user_id", "device_id");

-- CreateIndex
CREATE INDEX "remote_targets_user_id_idx" ON "remote_targets" ("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "remote_connections_user_id_target_device_id_controller_device_id_key" ON "remote_connections" (
    "user_id", "target_device_id", "controller_device_id"
);

-- CreateIndex
CREATE INDEX "remote_connections_user_id_controller_device_id_idx" ON "remote_connections" ("user_id", "controller_device_id");

-- CreateIndex
CREATE INDEX "remote_connections_user_id_target_device_id_idx" ON "remote_connections" ("user_id", "target_device_id");
...
ALTER TABLE "public_conversation_snapshots" ADD CONSTRAINT "public_conversation_snapshots_conversation_id_fkey" FOREIGN KEY (
    "conversation_id"
...
ALTER TABLE "device_logins" ADD CONSTRAINT "device_logins_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations" (
    "id"
) ON DELETE SET NULL ON UPDATE CASCADE;
