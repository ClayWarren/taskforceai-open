...
import { FixedRNG, RealRNG, systemRNG } from './rng';
...
describe('random/rng', () => {
  describe('RealRNG', () => {
    ...
    it('falls back to Math.random when Web Crypto is unavailable', () => {
      ...
      try {
        expect(new RealRNG().uuid()).toBe('01234567-89ab-4cde-b012-3456789abcde');
      } finally {
