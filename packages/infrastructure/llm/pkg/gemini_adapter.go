...
func (a *GeminiAdapter) toCoreChunk(resp *genai.GenerateContentResponse) agent.ChatCompletionChunk {
	return a.toCoreChunkWithState(resp, newGeminiToolCallState())
}
