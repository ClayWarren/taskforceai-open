...
export declare const semanticColorVariables: Record<string, string>;
export declare const semanticColorVars: Record<string, string>;
export declare function nativewindColors(mode?: 'light' | 'dark'): Record<string, string>;
