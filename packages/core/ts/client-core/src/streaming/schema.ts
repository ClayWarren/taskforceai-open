...
export const streamingPayloadSchema = z
  .object({
    type: z.string(),
...
const coerceStreamingPayload = (
  payload: z.infer<typeof streamingPayloadSchema>
): StreamingPayload => payload as StreamingPayload;
...
export const parseStreamingPayload = (
  ...
  return ok(coerceStreamingPayload(parsed.value));
};
