...
func (s *Service) handleMemberStatusChanged(ctx context.Context, props map[string]any) error {
...
func (s *Service) handleTeamCleaned(ctx context.Context, props map[string]any) error {
	...
	return s.sessions.RestoreLeadPermissions(ctx, leadSessionID, writeTools)
}
