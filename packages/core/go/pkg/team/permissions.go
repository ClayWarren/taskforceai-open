...
func (s *Service) ApprovePlan(ctx context.Context, teamName, memberName string, approved bool, feedback string) error {
	s.mu.Lock()
...
func (s *Service) sendPlanFeedback(ctx context.Context, teamName, memberName string, approved bool, feedback string) {
	action := "REJECTED"
