...
var (
	promptOverrideProviders = runtimevalue.New[PromptOverrideProvider](emptyPromptOverrideProvider{})
	configLoaderSources     = runtimevalue.New[ConfigLoaderSource](emptyConfigLoaderSource{})
)

func SetPromptOverrideProvider(provider PromptOverrideProvider) func() {
	return promptOverrideProviders.Set(provider)
}

func currentPromptOverrideProvider() PromptOverrideProvider {
	return promptOverrideProviders.Current()
}
...
func SetConfigLoaderSource(source ConfigLoaderSource) func() {
	restore := configLoaderSources.Set(source)
...
func currentConfigLoaderSource() ConfigLoaderSource {
	return configLoaderSources.Current()
}
