...
import { reloadPage } from '@taskforceai/shared/utils/browser-actions';
import { readCookieValue, setCookieSafely } from '@taskforceai/shared/utils/cookies';
...
export function CookieBanner() {
  ...
  const handleConsent = (value: 'true' | 'false') => {
    const result = setCookieSafely(`${COOKIE_NAME}=${value}; path=/; max-age=${ONE_YEAR_SECONDS}`);
    if (!result.ok) {
