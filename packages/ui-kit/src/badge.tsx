...
import { cn, variants, type VariantProps, type RemoveIndex } from './utils';
...
export interface BadgeProps
  extends RemoveIndex<React.HTMLAttributes<HTMLDivElement>>, VariantProps<typeof badgeVariants> {}
